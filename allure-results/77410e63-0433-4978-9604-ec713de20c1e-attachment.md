...
Call log:
  - waiting for locator('//input[@id="search"]')
    - waiting for" https://custodydigitization.finwyze.com/auth/realms/Fintuple/broker/after-post-broker-login?session_code=YXnGVa8R4_ym0wk7Vs6-PU_4X6xU3ekCkMLWOGrQ46M&client_id=admin-internal&tab_id=mSrsH9OCfOc" navigation to finish...
    - navigated to "https://cdi-r3.finwyze.com/admin/#state=06663095-ddb1-4d0e-b725-5061dd8d992c&session_state=292cded7-137a-4c6c-8ed4-7bf7b7374bf5&iss=https%3A%2F%2Fcustodydigitization.finwyze.com%2Fauth%2Frealms%2FFin…"

    at C:\Testing Details\Naveenraj\SampleTest\PlaywrightAutomation\tests\01-lam.spec.js:147:51
```
