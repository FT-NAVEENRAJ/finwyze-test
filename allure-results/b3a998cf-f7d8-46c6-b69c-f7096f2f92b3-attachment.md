...
```
Error: browserType.launch: Executable doesn't exist at C:\Users\NaveenrajD\AppData\Local\ms-playwright\chromium-1169\chrome-win\chrome.exe
╔═════════════════════════════════════════════════════════════════════════╗
...
> 22 | test("TC_01: Navigate to External Admin Dashboard", async () => {
  ...
  40 |     await addStamp.stampPaperAddition("1","21-10-2025","MAHARASHTRA","PMS AGREEMENT","700");
  41 |     await addStamp.stampPaperAddition("1","21-11-2025","MAHARASHTRA","POA","500");
  42 |
  43 |
  44 | });
  45 |
