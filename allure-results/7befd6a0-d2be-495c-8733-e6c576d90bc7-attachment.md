...
- Name: Modification Non-Adhar Flow >> TC_04: Verify the details are fetched after entering PAN
- Location: C:\Testing Details\Naveenraj\SampleTest\PlaywrightAutomation\tests\modFlowNonAadhar.spec.js:45:1
...
>  19 |     await page.goto("https://cd-r5.finwyze.com");
      |                ^ Error: page.goto: Target page, context or browser has been closed
   20 |     const loginPage = new LoginPage(page);
   21 |     await loginPage.login("Domestic Custody","FT.IPRU.AMCRM01@FINTUPLE.com", "Fintuple@1", "a2C4dE");
