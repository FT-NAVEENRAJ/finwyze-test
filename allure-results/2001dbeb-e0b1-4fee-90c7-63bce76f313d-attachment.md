...
- Name: TC_03: Login with Empty Fields
...
- link "Forgot Password":
  - /url: https://cd-r5.finwyze.com/auth/realms/Fintuple/login-actions/reset-credentials?client_id=landing-dashboard&tab_id=1VgVcqpxLgI
- button "Verify"
