...
- Location: C:\Testing Details\Naveenraj\SampleTest\PlaywrightAutomation\tests\02-login.spec.js:40:6
...
- link "Forgot Password":
  - /url: https://cd-r5.finwyze.com/auth/realms/Fintuple/login-actions/reset-credentials?client_id=landing-dashboard&tab_id=Aj8hzRiEPoo
- button "Verify"
...
```ts
  ...
  38 | });
  39 |
  40 | test.only('TC_03: Login with Empty Fields @regression' , async({page}) =>{
