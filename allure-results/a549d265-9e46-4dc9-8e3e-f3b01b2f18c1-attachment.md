...
Call log:
  - waiting for locator('#otpVerifyField')

    at LoginPage.enterOTP (C:\Testing Details\Naveenraj\SampleTest\PlaywrightAutomation\pages\loginPage.js:31:27)
    at C:\Testing Details\Naveenraj\SampleTest\PlaywrightAutomation\tests\03-investorProfile_i360.spec.js:18:21
```
