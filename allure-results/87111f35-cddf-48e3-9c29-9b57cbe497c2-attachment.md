...
- Location: C:\Testing Details\Naveenraj\SampleTest\PlaywrightAutomation\tests\02-login.spec.js:35:1
...
Call log:
  ...
  - waiting for locator('//small[@id="passwordError"]')
    ...
    at C:\Testing Details\Naveenraj\SampleTest\PlaywrightAutomation\tests\02-login.spec.js:43:64
```
...
- link "Forgot Password":
  - /url: https://cd-r5.finwyze.com/auth/realms/Fintuple/login-actions/reset-credentials?client_id=landing-dashboard&tab_id=6e_JYH_DAVs
- button "Verify"
