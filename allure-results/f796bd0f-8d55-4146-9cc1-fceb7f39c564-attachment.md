...
Call log:
  - waiting for locator('//input[@id="idSIButton9"]')
    - locator resolved to <input disabled value="Next" type="submit" id="idSIButton9" data-report-value="Submit" data-report-trigger="click" data-report-event="Signin_Submit" class="win-button button_primary high-contrast-overrides button ext-button primary ext-primary" data-bind="↵                attr: primaryButtonAttributes,↵                css: { 'high-contrast-overrides': svr.fUseHighContrastDetectionMode },↵                externalCss: {↵                    'button': true,↵                    'primary': true },↵        …/>
  ...
  - element was detached from the DOM, retrying
    - locator resolved to <input value="Next" type="submit" id="idSIButton9" data-report-value="Submit" data-report-trigger="click" data-report-event="Signin_Submit" class="win-button button_primary high-contrast-overrides button ext-button primary ext-primary" data-bind="↵                attr: primaryButtonAttributes,↵                css: { 'high-contrast-overrides': svr.fUseHighContrastDetectionMode },↵                externalCss: {↵                    'button': true,↵                    'primary': true },↵                v…/>
  - attempting click action
    2 × waiting for element to be visible, enabled and stable
      - element is not stable
    - retrying click action
  ...
  - retrying click action
    ...
    - waiting for element to be visible, enabled and stable
  - element was detached from the DOM, retrying
    - locator resolved to <input type="submit" value="Sign in" id="idSIButton9" data-report-attached="1" data-report-value="Submit" data-report-trigger="click" data-report-event="Signin_Submit" class="win-button button_primary high-contrast-overrides button ext-button primary ext-primary" data-bind="↵                attr: primaryButtonAttributes,↵                css: { 'high-contrast-overrides': svr.fUseHighContrastDetectionMode },↵                externalCss: {↵                    'button': true,↵                    'primary…/>
  - attempting click action
    2 × waiting for element to be visible, enabled and stable
      - element is not stable
    - retrying click action
  ...
  - retrying click action
    - waiting 100ms
    - waiting for" https://login.microsoftonline.com/47059aaf-2576-4c83-aa9a-1c4136ad73fe/login" navigation to finish...
    - navigated to "https://login.microsoftonline.com/47059aaf-2576-4c83-aa9a-1c4136ad73fe/login"
    - waiting for element to be visible, enabled and stable
  - element was detached from the DOM, retrying
    - waiting for" https://login.microsoftonline.com/kmsi" navigation to finish...
    - navigated to "https://login.microsoftonline.com/kmsi"

    at LAM_LoginPage.loginLamMaker (C:\Testing Details\Naveenraj\SampleTest\PlaywrightAutomation\pages\lamlogin.js:36:40)
    at C:\Testing Details\Naveenraj\SampleTest\PlaywrightAutomation\tests\01-lam.spec.js:148:7
```
