...
- Name: LAM ID Module Tests >> Checker Flow >> TC_01_05 (Approval): Approve the user creation task as Checker.
...
============================================================
    at C:\Testing Details\Naveenraj\SampleTest\PlaywrightAutomation\tests\01-lam.spec.js:171:18
```
