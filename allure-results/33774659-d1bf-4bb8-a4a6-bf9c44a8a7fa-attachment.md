...
- Location: C:\Testing Details\Naveenraj\SampleTest\PlaywrightAutomation\tests\01-lam.spec.js:106:5
...
Call log:
  - waiting for locator('xpath=(//i[@id="dropdown"])[1]')
    ...
    at C:\Testing Details\Naveenraj\SampleTest\PlaywrightAutomation\tests\01-lam.spec.js:115:54
```
