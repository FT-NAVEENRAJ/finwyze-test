...
- Name: LAM ID Module Tests >> TC_01_02: Create a Duplicate User for Maker
...
Call log:
  - waiting for locator('//button[@id="users"]')
    ...
    at C:\Testing Details\Naveenraj\SampleTest\PlaywrightAutomation\tests\01-lam.spec.js:67:7
```
