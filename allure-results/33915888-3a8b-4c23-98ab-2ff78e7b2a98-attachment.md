...
- Name: LAM ID Module Tests >> Checker Flow >> TC_03_02: Reject the user inactive task as Checker.
- Location: C:\Testing Details\Naveenraj\SampleTest\PlaywrightAutomation\tests\01-lam.spec.js:339:5
...
Call log:
  - navigating to "https://cdi-r3.finwyze.com/", waiting until "load"
    ...
    at C:\Testing Details\Naveenraj\SampleTest\PlaywrightAutomation\tests\01-lam.spec.js:336:18
```
