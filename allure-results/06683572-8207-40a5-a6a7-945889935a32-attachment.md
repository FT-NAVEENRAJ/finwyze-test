...
- Location: C:\Testing Details\Naveenraj\SampleTest\PlaywrightAutomation\tests\01-lam.spec.js:405:3
...
Call log:
  - navigating to "https://cdi-r3.finwyze.com/", waiting until "load"
    ...
    at C:\Testing Details\Naveenraj\SampleTest\PlaywrightAutomation\tests\01-lam.spec.js:401:16
```
...
> 401 |     await page.goto('https://cdi-r3.finwyze.com');
  ...
  487 | //   });
  488 | //   test("TC_05_01: Reject Task for custody Checker",async({})=>{
  489 | //     await new Promise(resolve => setTimeout(resolve, 4000));
  490 | //     page = await Promise.all([
  491 | //       page.waitForEvent("popup"), 
  492 | //       page.locator('//a[text()="View Task"]').click(), 
  493 | //       ]).then(([newPage]) => newPage);
  494 | //       await page.waitForLoadState();
  495 | //       await new Promise(resolve => setTimeout(resolve, 3000));
  496 | //     await page.locator('//input[@id="search"]').fill(generatedEmail);
  497 | //     await page.locator('//i[@id="dropdown"]').click();
  498 | //     await page.locator('//button[@id="Activate/Deactivate"]').click();
  499 | //     await page.locator('//textarea[@id="internal_user_comment"]').fill("Deactivate the User");
  500 | //     await page.locator('//button[@id="task_activate_Reject"]').click();
  501 | //     await new Promise(resolve => setTimeout(resolve, 2000));
```