...
Call log:
  - waiting for locator('//button[@id="users"]')

    at LAM_LoginPage.AddUser (C:\Testing Details\Naveenraj\SampleTest\PlaywrightAutomation\pages\lamlogin.js:60:36)
    at C:\Testing Details\Naveenraj\SampleTest\PlaywrightAutomation\tests\01-lam.spec.js:26:7
```
