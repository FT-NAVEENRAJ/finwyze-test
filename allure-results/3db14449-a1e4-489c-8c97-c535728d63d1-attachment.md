...
- Location: C:\Testing Details\Naveenraj\SampleTest\PlaywrightAutomation\tests\01-lam.spec.js:55:3
...
Call log:
  - waiting for getByPlaceholder('Password')
    ...
    at C:\Testing Details\Naveenraj\SampleTest\PlaywrightAutomation\tests\01-lam.spec.js:53:7
```
...
- main:
  ...
  - alert
  - textbox "Enter your email, phone, or Skype.": lam.id.mkr@fintuple.com
  - link "Can’t access your account?":
    - /url: "#"
  - button "Next"
  - paragraph: Welcome To Fintuple Technologies Private Limited!
- button "Sign-in options undefined": Sign-in options
- contentinfo:
  - link "Terms of use":
