...
- Name: Checker Flow >> TC_03_02: Approve the user activation task as Checker.
- Location: C:\Testing Details\Naveenraj\SampleTest\PlaywrightAutomation\tests\01-lam.spec.js:339:3
...
Call log:
  - waiting for locator('//input[@id="search"]')
    - waiting for" https://cdi-r3.finwyze.com/admin/" navigation to finish...
    - navigated to "https://cdi-r3.finwyze.com/admin/#state=56ff88f9-b5e6-4fea-9b96-e286eeca4bc5&session_state=dd07566e-86e2-45a6-8221-35ea21a2ba5b&iss=https%3A%2F%2Fcustodydigitization.finwyze.com%2Fauth%2Frealms%2FFin…"

    at C:\Testing Details\Naveenraj\SampleTest\PlaywrightAutomation\tests\01-lam.spec.js:347:46
```
...
```ts
  ...
  279 |   });
  280 |
  281 |   test('TC_02_07: Approve the user edit task as Checker.', async ({ page }) => {
  ...
  310 |   });
  311 |
  312 |   test('TC_03_01: Activate an inactive user as Maker. ', async ({ page }) => {
