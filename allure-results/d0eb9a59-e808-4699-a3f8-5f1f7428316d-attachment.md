...
- Name: Maker Flow >> TC_03_01: Active user as Maker 
- Location: C:\Testing Details\Naveenraj\SampleTest\PlaywrightAutomation\tests\01-lam.spec.js:312:3
...
Call log:
  - waiting for locator('//i[@id="dropdown"]')
    ...
    at C:\Testing Details\Naveenraj\SampleTest\PlaywrightAutomation\tests\01-lam.spec.js:324:47
```
