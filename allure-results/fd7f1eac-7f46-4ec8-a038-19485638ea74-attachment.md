...
- Name: LAM ID Module Tests >> Checker Flow >> TC_05_01: Reject Task for custody Checker
- Location: C:\Testing Details\Naveenraj\SampleTest\PlaywrightAutomation\tests\01-lam.spec.js:128:5
...
Call log:
  - navigating to "https://cdi-r5.finwyze.com/", waiting until "load"
    ...
    at C:\Testing Details\Naveenraj\SampleTest\PlaywrightAutomation\tests\01-lam.spec.js:125:18
```
