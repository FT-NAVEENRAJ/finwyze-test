...
- Location: C:\Testing Details\Naveenraj\SampleTest\PlaywrightAutomation\tests\01-lam.spec.js:425:3
...
Call log:
  - waiting for locator('//input[@type="email"]') to be visible
    ...
    at C:\Testing Details\Naveenraj\SampleTest\PlaywrightAutomation\tests\01-lam.spec.js:422:22
```
