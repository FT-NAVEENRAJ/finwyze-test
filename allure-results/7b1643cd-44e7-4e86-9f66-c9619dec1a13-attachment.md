...
Call log:
  - waiting for locator('//select[@id="jurisdiction"]')
    - locator resolved to <select id="jurisdiction" _ngcontent-ng-c2918879733="" formcontrolname="jurisdiction" ng-reflect-name="jurisdiction" class="ft-select ng-untouched ng-pristine ng-invalid">…</select>
  - attempting select option action
    ...
    - retrying select option action
      - waiting 100ms
    68 × waiting for element to be visible and enabled
       - did not find some options
     - retrying select option action
       - waiting 500ms
  ...
  - element was detached from the DOM, retrying
    ...
    at OfflineDocumentSection.selectJurisdiction (C:\Testing Details\Naveenraj\SampleTest\PlaywrightAutomation\pages\OfflineDocument.js:98:65)
    at OfflineDocumentSection.stampPaperAddition (C:\Testing Details\Naveenraj\SampleTest\PlaywrightAutomation\pages\OfflineDocument.js:107:22)
